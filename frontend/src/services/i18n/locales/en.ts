...
export default {
  ...
  features: {
    ...
    investments: {
      ...
      withdrawModalTitle: {
        compound: 'Withdraw from Compound',
        set: 'Withdraw from Set',
        uma: 'Withdraw from UMA',
        dharma: 'Withdraw from Dharma',
        melonport: 'Withdraw from Melonport',
      },
      supplyModalTitle: {
        compound: 'Supply to Compound',
        set: 'Supply to Set',
        uma: 'Supply to UMA',
        dharma: 'Supply to Dharma',
        melonport: 'Supply to Melonport',
      },
      categories: {
        saving: 'saving',
